...
$replaceText[$replaceText[$checkCondition[$getServerVar[autorole]!=];true;$giveRole];false;$repeatMessage][$replaceText[$replaceText[$checkCondition[$getServerVar[autorole]!=];true;$authorID;1];false;0];$replaceText[$replaceText[$checkCondition[$getServerVar[autorole]!=];true;$getServerVar[autorole]];false;]]
`
});
bd.onJoined()
